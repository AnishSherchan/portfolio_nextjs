...
const NavBar = () => {
  ...
  return (
    <div
      ...
      } transition-width duration-500 lg:block z-50 lg:sticky lg:top-0 bg-dark_secondary_background lg:min-h-screen lg:h-full lg:overflow-visible lg:py-5 lg:px-5 fixed bottom-0 sm:bottom-2 sm:rounded-3xl lg:rounded-none right-0 left-0 flex mx-auto overflow-x-auto sm:w-[450px]  px-2 py-2`}
    >
